...
{if $isSitejetPromptEnabled }
    <div id="sitejetAlertPrompt" class="alert alert-info alert-dismissible textblack clearfix">
        <button id="sitejetAlertClose" type="button" class="close">
        ...
        <a id="sitejetAlertActivate" href="{routePath('admin-utilities-sitejet-builder-index')}" class="btn btn-info btn-sm pull-right">
